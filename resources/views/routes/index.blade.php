...
@section('content')
    ...
    <div class="responsive">
        <div class="gallery">
            <a target="_blank"
                href="https://www.cedefop.europa.eu/en/data-insights/digital-skills-challenges-and-opportunities">
                <img src="/images/ds1.jpg" alt="digital-skills" width="800" height="400" />
            </a>
